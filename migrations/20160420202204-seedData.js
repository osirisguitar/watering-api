exports.up = function (r, connection) {
  return Promise.all([
    ...
    r.table('houses').insert({
      id: '8d76e546-ce33-489b-af74-4a6979e0124a',
      userId: '8bdd0c6c-a9f4-4255-ab92-c5f52d74bb2a',
      name: 'Rättaregården'
    }).run(connection),
    r.table('rooms').insert({
      id: '8d76e546-ce33-489b-af74-4a6979e0113a',
      houseId: '8d76e546-ce33-489b-af74-4a6979e0124a',
      name: 'Vardagsrummet'
    }).run(connection),
    r.table('rooms').insert({
...
exports.down = function (r, connection) {
  return Promise.all([
    r.table('plants').get('8bdd0c6c-a9f4-4255-ab92-c5f52d74bb2a').delete().run(connection),
